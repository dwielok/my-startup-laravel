        ...
        <div class="container">
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
                  ...
                  mb-6
                ">
                            <img src="{{ asset('images/team/team-01.png') }}" alt="image"
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
                  ...
                  mb-6
                ">
                            <img src="{{ asset('images/team/team-02.png') }}" alt="image"
                                class="w-full rounded-full" />
                            <span class="absolute top-0 left-0 z-[-1]">
                                <svg width="71" height="82" viewBox="0 0 71 82" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
                  ...
                  mb-6
                ">
                            <img src="{{ asset('images/team/team-03.png') }}" alt="image"
                                class="w-full rounded-full" />
                            <span class="absolute top-0 left-0 z-[-1]">
                                <svg width="71" height="82" viewBox="0 0 71 82" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full md:w-2/3 lg:w-6/12 xl:w-3/12 px-4">
                    ...
                    ">
                      ...
                      2xl:max-w-[120px]
                    ">
                                    <img src="{{ asset('images/footer/brands/ecommerce-html.svg') }}"
                                        alt="ecommerce-html" />
                                </a>
                            </li>
                            <li>
